...
function handleViewDetailsClick($productId) {
    ...
    // You can retrieve the data from your database or any other source
    $productData = [
        // Sample product data, replace with your own retrieval logic
        [
            'product_id' => 1,
            'name' => 'Product 1',
            'image' => 'product1.jpg',
    ...
    // Find the selected product in the product data array
