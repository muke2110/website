...
<body>
        ...
        <section>
            <div class="product-details">
                ...
                <div class="product-info">
                    ...
                    <button onclick="handleAddToCartClick(<?php echo $selectedProduct['product_id']; ?>)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
    ...
    <script>
        ...
        function handleAddToCartClick(productId) {
            ...
            // For example, you can use an AJAX request to send the productId to the server-side script

            // Display a notification to indicate that the product was added to the cart
